...
$("#live-video").hover(
    e => {
        $(".live-video-thumb")[0].setAttribute("src", "assets/home/lab-prev.gif")
    },
    e => {
        $(".live-video-thumb")[0].setAttribute("src", "assets/home/lab.jpg")
    }
)

$("#video-on-demand").hover(
    e => {
        $(".video-on-demand-thumb")[0].setAttribute("src", "assets/home/backstreetb-prev.gif")
    },
    e => {
        $(".video-on-demand-thumb")[0].setAttribute("src", "assets/home/backstreetb.jpg")
    }
)